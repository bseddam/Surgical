...
public partial class Lecture : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataTable dthead = db.GetHeaders(lang, 1, 13);
        if (dthead.Rows.Count > 0)
        {
            ltrlmuhazire.Text = dthead.Rows[0]["Name"].ToParseStr();
        }
        ...
        ltrlmuellif.Text = db.GetMenuHeader(lang, 20).Rows[0]["Name"].ToParseStr();
        ...
        string author = "";
        DataTable dtauthors = db.GetAuthors(lang, dtlecture.Rows[0]["LectureID"].ToParseInt(), "Mühazirə");
