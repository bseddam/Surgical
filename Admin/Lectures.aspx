<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SiteUser.Master" AutoEventWireup="true" CodeFile="Lectures.aspx.cs" Inherits="Category" %>
            ...
            <table class="table table-hover table-responsive">
                <thead>
                    <tr style="font-weight: bold; border: 1px solid;">
                        <td class="tdler">№</td>
                        <td class="tdler">Mühazirənin adı</td>
                        <td class="tdler">Növü</td>
                        <td class="tdler">Orqan</td>
                        <td class="tdler">Kurs</td>
                        <td class="tdler">Video_AZ</td>
                        <td class="tdler">Video_EN</td>
                        <td class="tdler">Video_RU</td>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="tdler"><%#Eval("LectureName") %></td>
                                <td class="tdler"><%#Eval("MainName_AZ") %></td>
                                <td class="tdler"><%#Eval("OrganName_AZ") %></td>
                                <td class="tdler"><%#Eval("LKurs") %></td>
                                <td class="tdler"><%#Eval("VideoURL_AZ") %></td>
                                <td class="tdler"><%#Eval("VideoURL_EN") %></td>
                                <td class="tdler"><%#Eval("VideoURL_RU") %></td>
                                <td class="tdler"><%#Eval("Muellifler") %></td>
                                <td class="tdler"><%#Eval("SortBy") %></td>
                                <td class="tdler">
                                    <asp:LinkButton ID="LinkButton5" CssClass="btn btn-primary" CommandName="Deyish" CommandArgument='<%#Eval("LectureID") %>' runat="server">Dəyiş</asp:LinkButton></td>
                                <td class="tdler">
                                    <asp:LinkButton ID="LinkButton6" CssClass="btn btn-danger" CommandName="Sil" CommandArgument='<%#Eval("LectureID") %>' runat="server">Sil</asp:LinkButton></td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                         <div class="col-lg-12">
                            ...
                            <div class="col-lg-8">
                                <asp:TextBox ID="txtLectureName" CssClass="form-control floatleft" runat="server" TextMode="MultiLine"></asp:TextBox>
                                <asp:RequiredFieldValidator CssClass="requiredstyle" ValidationGroup="qrup1" ControlToValidate="txtLectureName" ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="col-lg-4">
                        ...
                        <div class="col-lg-12">
                         ...
                         <div class="col-lg-12">
                            ...
                            <div class="col-lg-8">
                                ...
                                <asp:RequiredFieldValidator CssClass="requiredstyle" ValidationGroup="qrup1" ControlToValidate="txtKurs" ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-8">
                                <asp:FileUpload ID="UPVideoAZ" runat="server" />
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-8">
                                <asp:FileUpload ID="UPVideoEN" runat="server" />
                            </div>
                        </div>
                         <div class="col-lg-12">
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-8">
                                <asp:FileUpload ID="UPVideoRU" runat="server" />
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="col-lg-4">
