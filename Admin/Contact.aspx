<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SiteUser.Master" AutoEventWireup="true" CodeFile="Contact.aspx.cs" Inherits="Category" %>
            ...
            <table class="table table-hover table-responsive">
                <thead>
                    <tr style="font-weight: bold; border: 1px solid;">
                        <td class="tdler">№</td>
                        <td class="tdler">Əlaqə_AZ</td>
                        <td class="tdler">Əlaqə_EN</td>
                        <td class="tdler">Əlaqə_RU</td>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="tdler"><%#Eval("ContactAZ") %></td>
                                <td class="tdler"><%#Eval("ContactEN") %></td>
                                <td class="tdler"><%#Eval("ContactRU") %></td>
                                <td class="tdler">
                                    <asp:LinkButton ID="LinkButton5" CssClass="btn btn-primary" CommandName="Deyish" CommandArgument='<%#Eval("ContactID") %>' runat="server">Dəyiş</asp:LinkButton></td>
                                <td class="tdler">
                                    <asp:LinkButton ID="LinkButton6" CssClass="btn btn-danger" CommandName="Sil" CommandArgument='<%#Eval("ContactID") %>' runat="server">Sil</asp:LinkButton></td>
                ...
                <div class="modal-content" style="width: 100%">
                    ...
                    <div class="modal-body">
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-8">
                                <asp:TextBox ID="txtKateqoriyaAZ" CssClass="form-control floatleft" runat="server" TextMode="MultiLine"></asp:TextBox>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-8">
                                <asp:TextBox ID="txtKateqoriyaEN" CssClass="form-control floatleft" runat="server" TextMode="MultiLine"></asp:TextBox>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-8">
                                <asp:TextBox ID="txtKateqoriyaRU" CssClass="form-control floatleft" runat="server" TextMode="MultiLine"></asp:TextBox>
