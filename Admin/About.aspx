<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SiteUser.Master" AutoEventWireup="true" CodeFile="About.aspx.cs" Inherits="Category" %>
            ...
            <table class="table table-hover table-responsive">
                <thead>
                    <tr style="font-weight: bold; border: 1px solid;">
                        <td class="tdler">№</td>
                        <td class="tdler">Haqqında_AZ</td>
                        <td class="tdler">Haqqında_EN</td>
                        <td class="tdler">Haqqında_RU</td>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="tdler"><%#Eval("AboutAZ") %></td>
                                <td class="tdler"><%#Eval("AboutEN") %></td>
                                <td class="tdler"><%#Eval("AboutRU") %></td>
                                <td class="tdler">
                                    <asp:LinkButton ID="LinkButton5" CssClass="btn btn-primary" CommandName="Deyish" CommandArgument='<%#Eval("AboutID") %>' runat="server">Dəyiş</asp:LinkButton></td>
                                <td class="tdler">
                                    <asp:LinkButton ID="LinkButton6" CssClass="btn btn-danger" CommandName="Sil" CommandArgument='<%#Eval("AboutID") %>' runat="server">Sil</asp:LinkButton></td>
